 ...
 * Software files in this repository are licensed under the **[Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)](https://creativecommons.org/licenses/by-nc-sa/4.0/)**

- **Copyright:** [Philip McGaw](https://philipmcgaw.com/)

You may use, study, modify, and redistribute the sorcecode, schematic and PCB layout under those terms. **Derivative designs must be released under the same license.** If you share the design or boards built from it, include a copy of the license.
